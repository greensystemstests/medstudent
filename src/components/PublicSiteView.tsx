...
export const PublicSiteView: React.FC<PublicSiteViewProps> = ({ 
  ...
  const filteredUniversities = selectedProgramFilter === 'All'
    ? UNIVERSITIES
    : UNIVERSITIES.filter(u => u.programs.includes(selectedProgramFilter as any));
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-500/20 text-emerald-300 border border-emerald-400/30 text-xs font-semibold tracking-wide">
                ...
                <span>BULGARIAN MOES DIRECT ADMISSION GATEWAY</span>
              </div>

              <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold font-heading tracking-tight leading-[1.15]">
                Study Medicine & Dentistry in Bulgaria — <span className="text-emerald-400">100% in English</span>
              </h1>

              <p className="text-base sm:text-lg text-slate-300 max-w-2xl leading-relaxed font-normal">
                Direct, transparent gateway for international students seeking EU-accredited medical diplomas. 
                GMC (UK), USMLE (USA), and Arab Higher Education Council recognized with honest €180 onboarding and Sofia legal representation.
              </p>
              ...
              <div className="pt-4 border-t border-slate-700/60 grid grid-cols-2 sm:grid-cols-4 gap-4 text-xs text-slate-300">
                <div className="flex items-center gap-2">
                  ...
                  <span>EU Directive 2005/36/EC</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0" />
                  <span>UK GMC Register Eligible</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0" />
                  <span>WDOMS / ECFMG Listed</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0" />
              ...
              <div className="bg-gradient-to-br from-slate-900/90 to-slate-800/90 rounded-2xl border border-slate-700 p-6 shadow-2xl backdrop-blur-md relative overflow-hidden">
                <div className="flex items-center justify-between pb-4 border-b border-slate-700">
                  <div className="flex items-center gap-3">
                    <StudyBgLogo variant="mark" size="md" className="p-0.5 bg-slate-900/80 rounded-lg border border-slate-700" />
                    <div>
                ...
                <div className="mt-4 relative rounded-xl overflow-hidden aspect-video border border-slate-700">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent flex items-end p-3">
                    <span className="text-xs font-medium text-slate-200">
                      Sofia University Clinical Hospital & Dissection Halls
                    </span>
                  </div>
                </div>
      ...
      <section id="six-stages-section" className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-slate-600 mt-2 text-sm sm:text-base">
            From your secondary school certificate in your home country to continuous residency and clinical graduation in Bulgaria.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-xs hover:shadow-md transition-shadow relative">
            ...
            <p className="text-xs text-slate-600 leading-relaxed">
              We verify that your High School Biology and Chemistry combined average meets the mandatory 62% threshold set by the Bulgarian Ministry of Education & Science (MOES).
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 border-2 border-[#006644] shadow-xs hover:shadow-md transition-shadow relative">
            ...
            <p className="text-xs text-slate-600 leading-relaxed">
              Assisting with MOFA Hague Apostille verification in your home country, certified sworn translation into Bulgarian in Sofia, and physical filing at MOES.
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-xs hover:shadow-md transition-shadow relative">
            ...
            <p className="text-xs text-slate-600 leading-relaxed">
              Multiple-choice exam in Biology & Chemistry (plus English test if non-native). Access comprehensive past exam question banks and proctored mock testing.
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-xs hover:shadow-md transition-shadow relative">
            ...
            <p className="text-xs text-slate-600 leading-relaxed">
              Sofia Ministry issues the Certificate of Academic Admission. Non-EU candidates lodge their Bulgarian Long-Stay Type-D visa application with our consular dossier.
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-xs hover:shadow-md transition-shadow relative">
            ...
            <p className="text-xs text-slate-600 leading-relaxed">
              In-person registration at the Dean’s Office, student ID and library card issuance, local SIM card, student bank account, and certified housing contracts.
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-xs hover:shadow-md transition-shadow relative">
            ...
            <h3 className="font-heading font-bold text-base text-slate-900 mb-1">
              Annual Residence Permit (VRN) Tracker
            </h3>
            <p className="text-xs text-slate-600 leading-relaxed">
              Automated 84-day renewal countdown, university enrollment certificates (Uverenie), MVR migration appointment booking, and clinical elective guidance.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="universities-section" className="py-16 bg-slate-100/70 border-y border-slate-200 px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-4">
            <div>
              ...
              <p className="text-slate-600 text-sm mt-1">
                State universities offering 6-year Master of Medicine and 5.5-year Dental programs in English.
              </p>
            </div>
              ...
              >
                ...
                <div className="relative aspect-16/9 overflow-hidden bg-slate-900">
                  ...
                  <div className="absolute bottom-3 left-3 right-3 bg-gradient-to-t from-black/80 to-transparent p-2 rounded-lg">
                    <span className="text-xs text-emerald-300 font-semibold">{uni.badge}</span>
                  </div>
                </div>
      ...
      <section id="pricing-section" className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h2 className="text-2xl sm:text-4xl font-extrabold font-heading text-slate-900 mt-3">
            Transparent Pricing: €180 vs Predatory Agency Fees
          </h2>
          <p className="text-slate-600 mt-2 text-sm">
            Most commercial intermediaries charge €3,500 to €7,000 for basic paperwork. StudyBg replaces black-box agencies with transparent software, verified sworn translation, and direct Sofia legal representation.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-6 bg-gradient-to-b from-[#0f1e36] to-[#00281b] text-white rounded-2xl p-8 border border-emerald-500/30 shadow-xl flex flex-col justify-between relative overflow-hidden">
            <div className="absolute top-0 right-0 bg-[#006644] text-white text-xs font-bold uppercase tracking-wider px-4 py-1 rounded-bl-xl">
              Official Direct Model
            </div>

            <div>
              <div className="flex items-center gap-2 mb-2">
                <span className="font-heading font-bold text-xl">StudyBg Direct Admissions & Portal</span>
              </div>
              <div className="flex items-baseline gap-2 mb-4">
                <span className="text-4xl sm:text-5xl font-extrabold font-heading text-emerald-400">€180</span>
                <span className="text-slate-300 text-sm">One-Time Onboarding Fee</span>
              </div>
              <p className="text-xs text-slate-300 leading-relaxed mb-6">
                Covers your verified eligibility dossier review, Sofia legal advisor session, entrance exam syllabus prep kit, and access to all 6 journey stages.
              </p>
          ...
          <div className="lg:col-span-6 bg-white rounded-2xl p-8 border border-slate-200 shadow-xs flex flex-col justify-between text-slate-800">
            <div>
              <div className="flex items-center gap-2 mb-2 text-rose-600 font-semibold text-xs uppercase tracking-wider">
                ...
                <span>Traditional Commercial Agency Model</span>
              </div>
              <h3 className="font-heading font-bold text-xl text-slate-900 mb-1">Unregulated Third-Party Agents</h3>
              <div className="flex items-baseline gap-2 mb-4">
                <span className="text-3xl sm:text-4xl font-extrabold font-heading text-slate-500 line-through">€3,500 – €7,000</span>
                <span className="text-rose-600 font-semibold text-xs">Exorbitant Markups</span>
              </div>
              <p className="text-xs text-slate-600 leading-relaxed mb-6">
                Most international students fall victim to middlemen who disguise public university application forms behind thousands of euros in unitemized commissions.
              </p>

              <div className="space-y-3 text-xs text-slate-600">
                <div className="flex items-start gap-2.5">
                  <span className="w-4 h-4 rounded-full bg-rose-100 text-rose-600 font-bold flex items-center justify-center shrink-0 mt-0.5">✕</span>
                  <span><strong>Secretive Commissions:</strong> Hidden €1,500 translation fees that actually cost €180.</span>
                </div>
                <div className="flex items-start gap-2.5">
                  <span className="w-4 h-4 rounded-full bg-rose-100 text-rose-600 font-bold flex items-center justify-center shrink-0 mt-0.5">✕</span>
                  <span><strong>Hostage Documents:</strong> Withholding official Ministry admission letters until final balance is paid.</span>
                </div>
                <div className="flex items-start gap-2.5">
                  <span className="w-4 h-4 rounded-full bg-rose-100 text-rose-600 font-bold flex items-center justify-center shrink-0 mt-0.5">✕</span>
                  <span><strong>Zero Post-Arrival Care:</strong> No support when annual residence permit expires in Year 2.</span>
                </div>
                <div className="flex items-start gap-2.5">
                  <span className="w-4 h-4 rounded-full bg-rose-100 text-rose-600 font-bold flex items-center justify-center shrink-0 mt-0.5">✕</span>
                  <span><strong>Unqualified Sales Reps:</strong> Subcontracted call centers with no Sofia legal qualification.</span>
                </div>
              </div>
            </div>
            ...
            <div className="pt-8 border-t border-slate-100 mt-6">
              <div className="text-xs text-slate-500 bg-slate-50 p-3 rounded-xl">
                💡 <strong>Bulgarian Higher Education Fact:</strong> Bulgarian State Universities do not grant exclusive monopolies to commercial agencies. You are legally entitled to direct representation.
              </div>
            </div>
          </div>
        </div>
      ...
      {/* FAQs Section */}
      <section id="faqs-section" className="py-16 bg-slate-50 border-t border-slate-200 px-4 sm:px-6 lg:px-8">
            ...
            {FAQS.map((faq, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <span className="font-heading font-bold text-sm text-slate-900">{faq.q}</span>
                    <ChevronDown
      ...
      {/* Footer */}
      <footer className="bg-[#0f1e36] text-slate-400 py-12 px-4 sm:px-6 lg:px-8 border-t border-slate-800 text-xs">
        ...
        <div className="max-w-7xl mx-auto pt-6 border-t border-slate-800/80 flex flex-col sm:flex-row items-center justify-between gap-3 text-slate-500 text-[11px]">
          <div>© 2025 StudyBg Medical Gateway. All rights reserved.</div>
          <div className="flex items-center gap-4">
            <span className="hover:text-slate-400 cursor-pointer">Privacy Notice</span>
            <span className="hover:text-slate-400 cursor-pointer">Terms of Representation</span>
            <span className="hover:text-slate-400 cursor-pointer">GDPR Policy</span>
          </div>
        </div>
      </footer>
    </div>
